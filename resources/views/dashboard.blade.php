        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('donor.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                            <x-icon.plus />
                            Create new Donor Payment
                        </a>
                        <a href="{{ route('donor.create') }}" class="btn btn-primary d-sm-none btn-icon"
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                {{ $all_payment }} Total Payment
                                            </div>
                                            <div class="text-muted">
                                                {{ $today_payment??0 }} today
                                            </div>
                                        </div>
                                    </div>
                                </div>
