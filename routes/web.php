...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/donor-create', [DonorController::class, 'createIndex'])->name('donor.create');
    Route::post('/donor-create-save', [DonorController::class, 'createSave'])->name('donor-create-save');
    Route::get('/donor-record-edit/{id}', [DonorController::class, 'update'])->name('donor.edit');
    Route::post('/donor-record-update-save/{id}', [DonorController::class, 'updateSave'])->name('donor.edit.save');
    Route::get('/donor-record-delete/{id}', [DonorController::class, 'Delete'])->name('donor.delete');
    Route::get('/donors/export', [DonorController::class, 'export'])->name('donor.export');
